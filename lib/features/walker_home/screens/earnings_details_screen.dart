...
class EarningsDetailsScreen extends StatefulWidget {
  ...
  @override
  State<EarningsDetailsScreen> createState() =>
      _EarningsDetailsScreenState();
}

class _EarningsDetailsScreenState
    extends State<EarningsDetailsScreen> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        const Text(
                          'Your earnings for the selected period will appear here.',
