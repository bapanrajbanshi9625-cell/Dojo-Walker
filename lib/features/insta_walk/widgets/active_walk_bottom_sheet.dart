...
class ActiveWalkBottomSheet extends StatelessWidget {
      ...
      child: Container(
        ...
        child: ListView(
          ...
          children: <Widget>[
              ...
              children: <Widget>[
                Expanded(
                  child: ActiveWalkStatCard(
                    value: _distanceText,
                    title: reached ? 'Distance' : 'To Owner',
                  ),
                ),
            ...
            //
            // IMPORTANT:
            // Reach hone ke baad yahan koi second Reach slider
            // nahi dikhega.
            //
            // Live Walk screen par Start Walk hoga.
            // ====================================================
    ...
    return Container(
      ...
      child: const Row(
        children: <Widget>[
          ...
          Expanded(
            child: Text(
              'Owner reached. Live Walk is ready.',
              style: TextStyle(
                color: AppColors.success,
                fontSize: 13,
  ...
  Future<void> _callOwner() async {
    final String phone = request.ownerPhone.trim();
  ...
  String get _ownerNameText {
    final String value = request.ownerName.trim();
  ...
  String get _dogNameText {
    final String value = request.dogName.trim();
  ...
  String get _pickupText {
    final String pickup = request.pickupAddress.trim();
  ...
  // DESTINATION
  //
  // Owner coordinates ko destination ke roop mein duplicate
  // nahi karna.
  // ============================================================
  ...
  String get _etaText {
    ...
    final double minutes =
        (distanceKm / walkingSpeedKmPerHour) * 60;
    ...
    final int remainingMinutes = roundedMinutes % 60;
  ...
  String get _walkStatusText {
    ...
    switch (liveStatus.trim().toLowerCase()) {
      case 'searching':
        return 'Searching';
