  ...
  void _openDocumentViewer(
    ...
    if (cleanUrl.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Document is not available.'),
        ),
      );
      return;
    }
    ...
    return Scaffold(
      ...
      body: StreamBuilder<
        ...
        builder: (
          ...
          final String address = _firstString(
            data,
            <String>[
              'Adress',
              'Address',
          ...
          final String pincode = _firstString(
            data,
            <String>[
              'Pincode',
              'pincode',
          ...
          final String aadhaar = _firstString(
            data,
            <String>[
              'Aadhar Number',
              'Aadhaar Number',
          ...
          final String selfie = _firstString(
            data,
            <String>[
              'selfieUrl',
              'selfie',
          ...
          final String panCard = _firstString(
            data,
            <String>[
              'panCardUrl',
              'panCard',
          ...
          final bool frontUploaded =
              aadhaarFront.isNotEmpty ||
                  ...
                  data['aadhaarFrontUploaded'] == true;

          final bool backUploaded =
              aadhaarBack.isNotEmpty ||
                  data['aadhaar_back_uploaded'] == true ||
                  data['aadhaarBackUploaded'] == true;

          final bool panUploaded =
              panCard.isNotEmpty ||
                  data['pan_card_uploaded'] == true ||
                  data['panCardUploaded'] == true;
            ...
            child: Column(
              ...
              children: [
                ...
                ProfileDocumentCard(
                  ...
                  onDownload: aadhaarFront.isEmpty
                      ? null
                      : () {
                          _downloadDocument(
                            context,
                ...
                ProfileDocumentCard(
                  ...
                  onDownload: aadhaarBack.isEmpty
                      ? null
                      : () {
                          _downloadDocument(
                            context,
